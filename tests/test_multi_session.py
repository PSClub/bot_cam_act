...
async def test_multi_session_initialization():
    ...
    try:
        ...
        # Test session initialization with assignments for Saturday (headless mode for testing)
        success = await multi_session_manager.initialize_sessions_with_assignments('Saturday', headless=True)
